# Headless RTX render of shadow_padtac_biotac.usd from several angles -> PNGs.
import argparse
import os
...
OUT_DIR = "/home/nalin/roto_2/padtac_biotac_views"
...
sim_utils.DomeLightCfg(intensity=2500.0, color=(0.9, 0.9, 0.9)).func(
    "/World/DomeLight", sim_utils.DomeLightCfg(intensity=2500.0)
)
sim_utils.DistantLightCfg(intensity=2500.0).func(
    "/World/KeyLight", sim_utils.DistantLightCfg(intensity=2500.0), translation=(0.2, -0.3, 0.6)
)
...
# orbit angles: azimuth deg, elevation deg. Extra fingertip-focused views.
views = {
    "dorsal": (0.0, 20.0),
    "palmar": (180.0, 20.0),
    "left": (60.0, 20.0),
    "right": (-60.0, 20.0),
    "top": (0.0, 70.0),
    "tips": (0.0, -25.0),  # look up at the fingertips (biotac check)
}
for name, (az, el) in views.items():
    ...
    save_png(rgb, f"{OUT_DIR}/padtac_biotac_{name}.png")
